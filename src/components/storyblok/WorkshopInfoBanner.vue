<template>
  <div v-editable="blok"
       class="workshop-info-banner" 
      :class="blok.background_color + (showMoreInfo ? ' show-more-info' : '') 
    ...
    <div class="layer all-details-layer"
      ...
      <div class="content py-4 d-flex align-items-center">
        ...
        <transition name="fade">
          <vue-markdown v-if="(windowWidth <= 991.98) || showAllDetails"
              class="markdown-body mt-3 px-4 align-self-start" 
              :source="blok.detail_text">
